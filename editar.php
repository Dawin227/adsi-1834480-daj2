...
<?php
    ...
    $sql0 = "SELECT * FROM genero_daj";
    $stm0 = $conn->prepare($sql0);
    $stm0->execute();

    $sql11 = "SELECT * FROM region_daj";
    $stm2 = $conn->prepare($sql11);
    $stm2->execute();
   
    $sql12 = "SELECT * FROM estadocivil_daj";
    $stm3 = $conn->prepare($sql12);
    $stm3->execute();

    $sql13 = "SELECT * FROM tipodeinstitucion_daj";
    $stm4 = $conn->prepare($sql13);
    $stm4->execute();

    $sql14 = "SELECT * FROM tiempo_de_graduado_daj";
    $stm5 = $conn->prepare($sql14);
    $stm5->execute();
    
    $sql15 = "SELECT * FROM  nivelacademicopapa_daj";
    $stm6 = $conn->prepare($sql15);
    $stm6->execute();
   
    $sql16 = "SELECT * FROM  nivelacademicomama_daj";
    $stm7 = $conn->prepare($sql16);
    $stm7->execute();
  
     $sql16 = "SELECT * FROM  tipodevivienda_daj";
    $stm8 = $conn->prepare($sql16);
    $stm8->execute();

    $sql17 = "SELECT * FROM  calificatucarrera_daj";
    $stm9 = $conn->prepare($sql17);
    $stm9->execute();

//SELECCIONAR DATOS DE LA TABLA ENCUESTA 
$sql="SELECT region_daj.region,
genero_daj.genero,
estadocivil_daj.estadocivil,
nivelacademicomama_daj.nivelacademico_mama,
nivelacademicopapa_daj.nivelacademico_papa,
tipodevivienda_daj.tipodevivienda,
tipodeinstitucion_daj.tipodeinstitucion,
tiempo_de_graduado_daj.tiempo_de_graduado,
calificatucarrera_daj.calificatucarrera,
encuesta_daj.id_daj,encuesta_daj.identificacion,encuesta_daj.nombre,encuesta_daj.apellido,encuesta_daj.email,
encuesta_daj.telefono,encuesta_daj.direccion,encuesta_daj.nacimiento,encuesta_daj.actividaddelpapa,
encuesta_daj.actividaddelamama,encuesta_daj.carrera,encuesta_daj.id_ingresoeconomico,encuesta_daj.asignaturas_matriculadas 
FROM encuesta_daj 
INNER JOIN region_daj ON encuesta_daj.id_region = region_daj.id
INNER JOIN genero_daj ON encuesta_daj.id_genero = genero_daj.id
INNER JOIN estadocivil_daj ON encuesta_daj.id_estadocivil = estadocivil_daj.id
INNER JOIN nivelacademicomama_daj ON encuesta_daj.id_nivelacademicoMama = nivelacademicomama_daj.id
INNER JOIN nivelacademicopapa_daj ON encuesta_daj.id_nivelacademicoPapa = nivelacademicopapa_daj.id
INNER JOIN tipodevivienda_daj ON encuesta_daj.id_tipodevivienda = tipodevivienda_daj.id
INNER JOIN tipodeinstitucion_daj ON encuesta_daj.tipodeinstitucion = tipodeinstitucion_daj.id
INNER JOIN tiempo_de_graduado_daj ON encuesta_daj.tiempo_de_graduado = tiempo_de_graduado_daj.id
INNER JOIN calificatucarrera_daj ON encuesta_daj.calificatucarrera = calificatucarrera_daj.id
